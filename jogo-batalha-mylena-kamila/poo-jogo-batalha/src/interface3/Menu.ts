...
import Letalis from "../personagens/Letalis";
...
function criarPersonagem() {
    ...
    const classe = readlineSync.question("\t>> Escolha a classe (1-4): ");
    ...
    let ataque: number;
    if (classe !== "4"){
        ataque = Number(readlineSync.question("\t>> Ataque (1-100): "));
    }
    ...
    try {
        ...
        // =========== LETALIS ========
            ...
            personagem = new Letalis(nome, vida);
        }
        else {
